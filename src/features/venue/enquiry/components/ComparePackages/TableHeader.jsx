        ...
        <>
            ...
            {criteriaCard && (
                ...
                <div className="fixed inset-0 z-80 flex justify-center items-start pt-20 px-4 -top-9">
                    <div className="w-110 h-auto max-w-xl bg-white rounded-[8px] px-6 max-h-[90vh] overflow-auto">    
                        
                        <div className='sticky top-0 flex bg-[#fd4304] -mx-6 h-16 items-center pr-2'>
                            <h1 className='text-[#ffffff] text-[20px] font-bold flex-1 text-center'>Matching Criteria</h1>
                            <X size={22} className='cursor-pointer text-[#ffffff]' onClick={() => setCriteriaCard(false)}/>
                        </div>

                        <div className='w-full h-auto bg-[#fff4f4] border border-[1px] border-dashed border-[#e2e8f0] hover:bg-[#fff5f8] hover:border-gray-200 hover:border-solid mt-4 p-5'>
                        ...
                        <div className='w-full px-5 py-6'>
                            <div className='w-full h-full'>
                                <div className='grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-15'>
                                    <div>
                                ...
                                <div className='w-full h-auto p-4 mt-10 bg-[#f8f9fa] border border-[1px] border-dashed border-[#e0e0e0] rounded-[8px]'>
                                    ...
                                    <div className='w-full h-auto grid grid-cols-1 sm:grid-cols-[35%_35%_30%] gap-4 sm:gap-0'>
                                        <div className='flex gap-2 items-center'>
                                            <PiForkKnifeFill size={18} className='text-[#777] hover:text-[#fd4304] transition-transform duration-300 ease-in-out hover:-translate-y-1'/>
                                        ...
                                        <div className='flex gap-2 items-center ml:0 sm:ml-3'>
                                            <BsGrid3X3GapFill size={18} className='text-[#777] hover:text-[#fd4304] transition-transform duration-300 ease-in-out hover:-translate-y-1' />
                                            <div className='leading-none'>
                                        ...
                                        <div className='flex gap-2 items-center ml:0 sm:ml-1'>
                                            <FaGift size={18} className='text-[#777] hover:text-[#fd4304] transition-transform duration-300 ease-in-out hover:-translate-y-1' />
                                            <div className='leading-none'>
                                ...
                                <div className='w-full pt-6'>
                                    <button className='w-full bg-[linear-gradient(135deg,#fdeaed,#fff3ea)] shadow-[0_6px_16px_#3d281726] -translate-y-[2px]
                                        border border-[1px] border-solid border-[#ff4000] transition-transform duration-300 ease-in-out hover:-translate-y-1 cursor-pointer
                                        text-[#ff4000] !font-bold py-3 rounded-full'>Send Contract</button>
                                </div>

                                <div className='w-full text-center py-6'>
                                    <p className='underline hover:!text-[#fd4304] cursor-pointer' onClick={() => 
                                        {
                                          setAddPackage(false)
