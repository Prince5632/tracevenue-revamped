...
//         <div className="p-2 flex gap-2 border-b border-gray-300 bg-gray-100 sticky top-0 ">
...
//               className={`p-3 cursor-pointer  transition truncate 
//                 ${
...
//       <div
//         onClick={handleClick}
//         className="flex-1 bg-white rounded-[30px] border border-[#D7D9DA] ml-4 mt-4 h-[300px]"
//       >
//         <LoadScript
