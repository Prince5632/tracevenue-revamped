...
const Location = ({ urlParams = {} }) => {
  ...
  const [showRadiusSlider, setShowRadiusSlider] =
  ...
  return (
    <div ref={wrapperRef} className="w-full relative pb-18">
      ...
      <div className="relative z-4 w-full">
        ...
        {showOptions && (
          <div className="absolute top-full left-0 w-full mt-0 z-100 bg-white rounded-2xl shadow-lg border border-[#d7d9da] overflow-hidden">
            <div
              className="p-4 bg-gray-50 border-b border-gray-100 cursor-pointer hover:bg-gray-100 transition-colors"
      ...
      <div className="rounded-2xl mt-8 relative z-0 w-full overflow-hidden border border-gray-200 ">
        {isLoading && (
