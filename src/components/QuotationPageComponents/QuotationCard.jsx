        ...
        {quotations.map((quotation) => (
          <div key={quotation.id}>
            ...
            <div className="p-3 flex justify-between items-center">
              <p className="!text-black !text-[18px] font-bold hover:!text-[#ff4000]">
                {quotation.name}
              </p>
            ...
            <div className="px-3 flex items-center gap-2 mb-6">
              <span className="text-[#666] text-[14px] !font-semibold">
                <svg
                  ...
                  class="lucide lucide-map-pin info-icon"
                  aria-hidden="true"
                >
            ...
            <div className="flex items-center p-3 justify-between mb-2 gap-2 h-auto w-full">
              <button className="bg-[#fff5f0] border border-[#ff4000] text-[#ff4000] px-3 py-3 !rounded-[7px] !text-[14px] w-full  !font-bold hover:bg-[#ff4000] hover:text-white cursor-pointer">
                Ask for Quote
              </button>
