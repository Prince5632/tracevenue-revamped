...
const SearchBar = ({
    ...
    <div ref={wrapperRef} className="relative"> 
      ...
      {isOpen && (
        <div className="absolute z-50 w-full bg-white border border-gray-300 rounded-2xl shadow-lg mt-2 p-4">
          ...
          {isTyping && value && searchResults.length > 0 && (
            <>
              <p className="text-sm !text-[#555] font-semibold !mb-2">
                Search Results
              </p>
  ...
  ${
    event.id === selectedItem || event.label === value
      ? "!text-[#15b076]"
      : "!text-black hover:text-green-600 hover:!text-[#15b076]"
  }`}
                  >
                    {event.label}
                  </p>
