        ...
        <>
            <main>
                <div className='pb-4'>
                    ...
                    <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Cum voluptatem, sapiente minima ab quis exercitationem.</p>
                </div>
                <div className='w-full sm:flex  sm:items-stretch sm:gap-2 py-2'>
